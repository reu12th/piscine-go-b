...
# ---------------------------
# QUEST 11: Linked Lists
# ---------------------------
files["listpushback.go"]="q11 t1"
files["listpushfront.go"]="q11 t2"
files["listsize.go"]="q11 t3"
files["listlast.go"]="q11 t4"
files["listat.go"]="q11 t5"
files["listreverse.go"]="q11 t6"
files["listforeach.go"]="q11 t7"
files["listforeachif.go"]="q11 t8"
files["listfind.go"]="q11 t9"
files["listremoveif.go"]="q11 t10"
files["listmerge.go"]="q11 t11"
files["listsort.go"]="q11 t12"
files["sortedlistmerge.go"]="q11 t13"
...
files["btreedeletenode.go"]="q12 t7"
...
for file in "${!files[@]}"; do
    if [[ -f "$file" ]]; then
        ...
        echo "Committed $file -> ${files[$file]}"
    else
